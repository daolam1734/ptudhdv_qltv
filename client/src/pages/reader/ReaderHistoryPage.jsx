  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500 pb-20">
        ...
        <div className="bg-gradient-to-r from-rose-500 to-rose-600 p-8 rounded-[2.5rem] text-white flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl shadow-rose-200">
           <div className="flex items-center gap-6">
              ...
              <div className="space-y-1">
                 <h4 className="text-xl font-bold">Bạn đang có phí phạt chưa thanh toán</h4>
                 <p className="text-rose-100 font-medium text-sm">Tổng nợ hiện tại: <span className="text-white font-black text-lg underline decoration-white/30">{user.unpaidFines.toLocaleString('vi-VN')}đ</span></p>
      ...
      <div className="bg-gray-900 rounded-[2.5rem] p-10 text-white relative overflow-hidden shadow-2xl shadow-gray-200">
         ...
         <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
            <div className="space-y-4">
                ...
                <p className="text-gray-400 text-sm max-w-xl font-medium leading-relaxed">Hệ thống áp dụng phí phạt <span className="text-white font-bold underline decoration-indigo-500">5.000đ/ngày</span> cho mỗi đầu sách quá hạn. Vui lòng thanh toán tại quầy khi trả sách để được tiếp tục sử dụng dịch vụ.</p>
            </div>
      ...
      <ConfirmModal 
        ...
        onConfirm={() => handleRenew(renewingItem?._id)}
