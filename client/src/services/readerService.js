...
export const payFine = (id, amount) => axiosInstance.post(`readers/${id}/pay-fine`, { amount });
...
const readerService = { getAll, getById, create, update, delete: remove, getHistory, getMyHistory, payFine, search, toggleFavorite, getFavorites };
